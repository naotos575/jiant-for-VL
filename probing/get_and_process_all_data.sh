...
JIANT_DATA_DIR=${1:-"/cl/work4/naoto-sh/glue_data"}  # path to glue_data directory

## Configure these for your environment ##
PATH_TO_ONTONOTES="/cl/work4/naoto-sh/v12/conll-formatted-ontonotes-5.0"
...
#To use OpenAI.BPE, you need to download the `spacy` and `ftfy` packages.
function preproc_task() {
    ...
    python $HERE/retokenize_edge_data.py -t "openai-gpt"     $TASK_DIR/*.json
...
function get_ontonotes() {
    ...
    ## and split = {train, development, test}
