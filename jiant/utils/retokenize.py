...
def get_aligner_fn(tokenizer_name: Text):
    ...
    if tokenizer_name == "MosesTokenizer" or tokenizer_name.startswith("transfo-xl-"):
        ...
        #uncased固定
        do_lower_case = True
        wpm_tokenizer = get_tokenizer("bert-base-uncased")
        return functools.partial(
        ...
        return functools.partial(
            align_bytebpe, bytebpe_tokenizer=bytebpe_tokenizer
        )
        ...
        return functools.partial(align_bytebpe, bpe_tokenizer=bpe_tokenizer)
