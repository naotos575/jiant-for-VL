...
def build_model(args, vocab, pretrained_embs, tasks, cuda_devices):
    ...
    #shirai_add
        ...
        log.info(f"Using  model ({args.input_module}).")
        embedder = VisualBertEmbedderModule(args)
        d_emb = embedder.get_output_dim()
